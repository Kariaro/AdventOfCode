...
public class Day5 extends DayBase {
	...
	public void run() throws Exception {
		List<Line> lines = Utils.readAllLines(this).stream().map(Line::new).toList();
	...
	public int partOne(List<Line> lines) throws Exception {
	...
	public int partTwo(List<Line> lines) throws Exception {
		final Map<Long, Long> system = new HashMap<>();
