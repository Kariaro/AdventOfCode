...
public class Day24_Post {
	...
	private static boolean backtraceMax(List<Problem> probs, int index, long target, LinkedList<Integer> stack) {
		if(index < 0) {
			return target == 0;
		}
	...
	private static boolean backtraceMin(List<Problem> probs, int index, long target, LinkedList<Integer> stack) {
		if(index < 0) {
			return target == 0;
		}
	...
	// time: 19:00 -> 20:24
	// Solve: 220 min
	public static long partOne(List<Problem> parts) throws Exception {
	...
	// Solve: 3 min
	public static long partTwo(List<Problem> parts) throws Exception {
		LinkedList<Integer> stack = new LinkedList<>();
