...
public class Day14 extends DayBase {
	...
	// Solve: 9 min
	public long partOne(String line, Map<String, Character> rules) throws Exception {
		return processCount(line, rules, 10);
	}
	
	// Solve 25 min
	public long partTwo(String line, Map<String, Character> rules) throws Exception {
